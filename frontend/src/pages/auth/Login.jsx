  ...
  return (
    <div style={{ position: "relative" }}>
      <span style={{
        ...
        pointerEvents: "none", zIndex: 2, transition: "opacity 0.2s",
      }}>
      ...
      <input
        ...
        style={{
          ...
          borderRadius: "8px", color: "#f5edd8", fontSize: "15px",
          ...
          caretColor: "#c9a96e",
          boxShadow: focused
            ? "0 0 0 3px rgba(201,169,110,0.08), inset 0 1px 0 rgba(255,255,255,0.06)"
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 540px) {
          .lg-card { padding: 38px 24px 34px; }
        }
      `}</style>
