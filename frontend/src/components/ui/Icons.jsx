...
// =================== Broom Icon ===================
export const BroomIcon = ({ size = 18, color = "currentColor" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// =================== Feedback Icon ===================
export const FeedbackIcon = ({ size = 18, color = "#C9A84C" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    <g>
      <path d="M11.566 1.017a.486.486 0 0 1 .868 0l1.009 2.034a.48.48 0 0 0 .363.262l2.264.327a.48.48 0 0 1 .389.323a.47.47 0 0 1-.121.487L14.7 6.044a.47.47 0 0 0-.138.419l.388 2.247a.47.47 0 0 1-.194.465a.49.49 0 0 1-.509.035l-2.021-1.054a.48.48 0 0 0-.452 0L9.758 9.21a.487.487 0 0 1-.673-.24a.5.5 0 0 1-.03-.26l.388-2.247a.47.47 0 0 0-.138-.42L7.662 4.45a.47.47 0 0 1 .028-.704a.5.5 0 0 1 .24-.106l2.264-.327a.48.48 0 0 0 .363-.262z" />

      <path d="M6.322 10.1l-.863-.45a.49.49 0 0 0-.453 0L2.991 10.7a.49.49 0 0 1-.51-.034a.47.47 0 0 1-.193-.466l.387-2.246a.47.47 0 0 0-.137-.419L.894 5.945a.472.472 0 0 1 .029-.705a.5.5 0 0 1 .24-.106l2.263-.327a.48.48 0 0 0 .364-.262L4.8 2.511a.48.48 0 0 1 .434-.267" />

      <path d="M17.678 10.1l.863-.45a.49.49 0 0 1 .453 0l2.015 1.05a.49.49 0 0 0 .51-.034a.47.47 0 0 0 .193-.466l-.387-2.246a.47.47 0 0 1 .137-.419l1.644-1.595a.47.47 0 0 0-.029-.704a.5.5 0 0 0-.24-.106l-2.263-.327a.48.48 0 0 1-.364-.262l-1.01-2.03a.48.48 0 0 0-.434-.267" />

      <path d="M7.877 15.447v1a5.9 5.9 0 0 1-.86 3.272m9.107-4.272v1a5.9 5.9 0 0 0 .859 3.272m-9.095-4.054A5.48 5.48 0 0 0 12 13.766a5.48 5.48 0 0 0 4.112 1.9" />

      <path d="M7.875 15.336a4.125 4.125 0 1 0 8.25 0a4.125 4.125 0 0 0-8.25 0m9.172 7.914a6.8 6.8 0 0 0-2.54-1.8L12 23.211l-2.507-1.757a6.8 6.8 0 0 0-2.53 1.784" />
    </g>
  </svg>
)
