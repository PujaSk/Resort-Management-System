...
const sendBookingCancellation = async ({
  ...
  try {
    ...
    if (isHall && cancelledDate) {
      ...
      const remainingRows = remainingDates.map((ymd, i) => `
        <tr style="background:${i % 2 === 0 ? "#f9f5ee" : "#ffffff"}">
          <td style="padding:9px 16px; color:#888; font-size:13px;">${i + 1}</td>
          <td style="padding:9px 16px; color:#222; font-size:13px; font-weight:600;">${fmtYMD(ymd)}</td>
          <td style="padding:9px 16px;">
            <span style="background:#e8f5e9; color:#2e7d32; padding:2px 9px; border-radius:12px; font-size:11px; font-weight:700;">Active</span>
          </td>
        </tr>
      `).join("");
            ...
            <table width="620" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="background:linear-gradient(135deg,#1a1208 0%,#2d2010 50%,#1a1208 100%);padding:40px 40px 30px;text-align:center;">
                  ...
                  <h1 style="margin:0;font-size:26px;color:#f5edd8;font-weight:700;letter-spacing:1px;">Date Cancelled</h1>
              ...
              <tr>
                <td style="background:#c0392b;padding:12px 40px;text-align:center;">
                  <p style="margin:0;font-size:12px;color:#ffffff;font-weight:700;letter-spacing:2px;text-transform:uppercase;">
                    Booking Reference: ${booking._id?.toString().slice(-8).toUpperCase()} — DATE CANCELLED
                  </p>
                </td>
              </tr>
              <tr>
                <td style="padding:35px 40px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #f5c6c6;">
                    ...
                    <tr>
                      ...
                      <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #f9eaea;">${roomType?.type_name || "—"}</td>
                    </tr>
                    <tr style="background:#fdfafa;">
                      <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f9eaea;">Date Cancelled</td>
                      <td style="padding:12px 16px;color:#c0392b;font-size:13px;font-weight:700;border-bottom:1px solid #f9eaea;">${fmtYMD(cancelledDate)}</td>
                    </tr>
                    <tr>
                      <td style="padding:12px 16px;color:#888;font-size:13px;">Per-day rate</td>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #c8e6c9;">
                    ...
                    <tr style="background:#f0f7f0;">
                      ...
                      <th style="padding:8px 16px;text-align:left;font-size:11px;color:#888;font-weight:600;border-bottom:1px solid #c8e6c9;">Date</th>
                      <th style="padding:8px 16px;text-align:left;font-size:11px;color:#888;font-weight:600;border-bottom:1px solid #c8e6c9;">Status</th>
                    </tr>
                    ${remainingRows}
                  </table>
                  ` : `
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #c8e6c9;">
                    ...
                    <tr>
                      ...
                      <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">₹${fmt(pricePerDay)}</td>
                    </tr>
                    <tr style="background:#fafffe;">
                      <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f0f4f0;">Cancellation fee (25% of day rate)</td>
                      <td style="padding:12px 16px;color:#c0392b;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">− ₹${fmt(hallFee)}</td>
                    </tr>
                    <tr>
                      <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f0f4f0;">You paid upfront</td>
                      <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">₹${fmt(paidAmt)}</td>
                    </tr>
                    ${hallIsHalfPay ? `
                    <tr style="background:#fafffe;">
                      <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f0f4f0;">Remaining balance waived</td>
                      <td style="padding:12px 16px;color:#2e7d32;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">₹${fmt(hallBalWaived)} <span style="font-weight:400;font-size:11px;color:#888;">(due on event day)</span></td>
                    </tr>
                    ` : ""}
                    <tr ${hallIsHalfPay ? "" : `style="background:#fafffe;"`}>
                      <td style="padding:12px 16px;color:#2e7d32;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">Refund Amount</td>
                      <td style="padding:12px 16px;color:${hallRefund > 0 ? "#2e7d32" : "#888"};font-size:15px;font-weight:700;border-bottom:1px solid #f0f4f0;">${hallRefund > 0 ? `₹${fmt(hallRefund)}` : "No refund"}</td>
                    </tr>
                    <tr ${hallIsHalfPay ? `style="background:#fafffe;"` : ""}>
                      <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f0f4f0;">Refund Status</td>
                      <td style="padding:12px 16px;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">
                        ${hallRefund > 0
                          ? `<span style="background:#e8f5e9;color:#2e7d32;padding:3px 10px;border-radius:20px;font-size:12px;">Initiated</span>`
                          : `<span style="background:#fef3c7;color:#92400e;padding:3px 10px;border-radius:20px;font-size:12px;">No Refund</span>`
                        }
                      </td>
                    </tr>
                    ${hallRefund > 0 ? `
                    <tr>
                      <td style="padding:12px 16px;color:#888;font-size:13px;">Expected Credit</td>
        ...
        <tr><td align="center">
          <table width="620" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="background:linear-gradient(135deg,#1a1208 0%,#2d2010 50%,#1a1208 100%);padding:40px 40px 30px;text-align:center;">
                <p style="margin:0 0 6px;font-size:11px;letter-spacing:4px;color:#C9A84C;text-transform:uppercase;">Royal Palace Resort</p>
                <h1 style="margin:0;font-size:26px;color:#f5edd8;font-weight:700;letter-spacing:1px;">Booking Cancelled</h1>
            ...
            <tr>
              <td style="background:#c0392b;padding:12px 40px;text-align:center;">
                <p style="margin:0;font-size:12px;color:#ffffff;font-weight:700;letter-spacing:2px;text-transform:uppercase;">
                  Booking Reference: ${booking._id?.toString().slice(-8).toUpperCase()} — CANCELLED
                </p>
              </td>
            </tr>
            <tr>
              <td style="padding:35px 40px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #e8e0d0;">
                  ...
                  <tr>
                    ...
                    <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #f0ebe2;">${fmtDate(booking.checkOutDateTime)}</td>
                  </tr>
                  <tr style="background:#fdfaf5;">
                  ...
                  <tr>
                    <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f0ebe2;">Total Booking Value</td>
                    <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #f0ebe2;">₹${fmt(totalAmt)}</td>
                  </tr>
                  <tr style="background:#fdfaf5;">
                    <td style="padding:12px 16px;color:#888;font-size:13px;">Amount Paid Upfront</td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #fde68a;">
                  ...
                  <tr>
                    ...
                    <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #fef3c7;">₹${fmt(totalAmt)}</td>
                  </tr>
                  <tr style="background:#fffbeb;">
                    <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #fef3c7;">Cancellation fee (15% of total)</td>
                    <td style="padding:12px 16px;color:#d97706;font-size:13px;font-weight:700;border-bottom:1px solid #fef3c7;">− ₹${fmt(roomFee)}</td>
                  </tr>
                  <tr>
                    <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #fef3c7;">Amount paid upfront</td>
                    <td style="padding:12px 16px;color:#222;font-size:13px;font-weight:700;border-bottom:1px solid #fef3c7;">₹${fmt(paidAmt)}</td>
                  </tr>
                  ${isHalfPay ? `
                  <tr style="background:#fffbeb;">
                    <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #fef3c7;">Remaining balance waived</td>
                    <td style="padding:12px 16px;color:#2e7d32;font-size:13px;font-weight:700;border-bottom:1px solid #fef3c7;">₹${fmt(duWaived)} waived</td>
                  </tr>
                  ` : ""}
                  <tr style="background:#fef3c7;">
                    <td style="padding:14px 16px;color:#92400e;font-size:13px;font-weight:700;">Refund Amount</td>
                    <td style="padding:14px 16px;color:${roomRefund > 0 ? "#2e7d32" : "#888"};font-size:15px;font-weight:700;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #c8e6c9;">
                  ...
                  <tr>
                    ...
                    <td style="padding:12px 16px;color:#2e7d32;font-size:14px;font-weight:700;border-bottom:1px solid #f0f4f0;">₹${fmt(roomRefund)}</td>
                  </tr>
                  <tr style="background:#fafffe;">
                    <td style="padding:12px 16px;color:#888;font-size:13px;border-bottom:1px solid #f0f4f0;">Refund Status</td>
                    <td style="padding:12px 16px;font-size:13px;font-weight:700;border-bottom:1px solid #f0f4f0;">
                ...
                <div style="background:#fdf8ee;border-left:4px solid #C9A84C;padding:15px 20px;border-radius:0 8px 8px 0;margin-bottom:25px;">
                  ...
                  <p style="margin:0;color:#666;font-size:13px;line-height:1.7;">
                    As per our policy, a <strong>15% cancellation fee of ₹${fmt(roomFee)}</strong> (on the total booking value of ₹${fmt(totalAmt)}) has been applied.
                ...
                <div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:15px 20px;border-radius:0 8px 8px 0;margin-bottom:25px;">
                  <p style="margin:0 0 6px;color:#92400e;font-size:13px;font-weight:700;">ℹ️ No Refund Applicable</p>
                  <p style="margin:0;color:#666;font-size:13px;line-height:1.7;">
