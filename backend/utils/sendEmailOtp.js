          ...
          <table width="600" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="color:#333;font-size:16px;line-height:1.6;">
                <p>Dear Guest,</p>
                <p>We received a request to verify your email address / reset your password. Please use the One-Time Password (OTP) below to continue.</p>
                <div style="text-align:center;margin:30px 0;">
                  <span style="display:inline-block;background:#2c3e50;color:#ffffff;padding:15px 30px;font-size:28px;letter-spacing:5px;border-radius:8px;font-weight:bold;">${otp}</span>
                </div>
                <p style="text-align:center;color:#888;font-size:14px;">This OTP is valid for <strong>10 minutes</strong>.</p>
                <p>If you did not request this verification, please ignore this email. Your account remains secure.</p>
                <p style="margin-top:30px;">Warm Regards,<br><strong>Royal Palace Resort Team</strong></p>
              </td>
            </tr>
            <tr>
