...
// Sends notification when a guest's room is switched by management
 ...
 * @param {Object} opts.roomType
 * @param {Object} opts.oldRoom
 * @param {Object} opts.newRoom
    ...
    <div style="padding:28px 36px;">
      ...
      <div style="text-align:center;padding:16px;background:rgba(201,168,76,.04);border:1px solid rgba(201,168,76,.12);border-radius:10px;">
        ...
        <p style="color:#C9A84C;font-size:13px;font-weight:700;margin:0;">
          📞 Front Desk &nbsp;|&nbsp; ✉ ${process.env.EMAIL_USER || "reception@royalpalaceresort.com"}
        </p>
      </div>
    </div>
