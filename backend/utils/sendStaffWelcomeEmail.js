...
const DESIGNATION_EMOJI = {
  Manager: "👔", Receptionist: "🎯", Housekeeping: "🧹", Chef: "👨‍🍳", Security: "🛡",
};
        ...
        <tr>
          <td style="padding:32px 40px;">
            <p style="font-size:15px;color:#C8BAA0;margin:0 0 24px;">
              ...
              Your staff account has been created at <strong style="color:#C9A84C;">Royal Palace Resort</strong>. You can now log in to the staff portal using the credentials below.
            </p>
            <div style="text-align:center;margin-bottom:28px;">
              <span style="display:inline-block;padding:8px 20px;border-radius:30px;background:rgba(201,168,76,.1);border:1px solid rgba(201,168,76,.3);font-size:13px;font-weight:700;color:#C9A84C;letter-spacing:0.08em;">${emoji} ${staff.designation}</span>
            </div>
            <div style="background:rgba(255,255,255,.03);border:1px solid rgba(201,168,76,.25);border-radius:12px;padding:20px 24px;margin-bottom:24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:8px 0;border-bottom:1px solid rgba(255,255,255,.05);"><span style="font-size:12px;color:#6B6054;">Email</span></td>
                  <td style="padding:8px 0;border-bottom:1px solid rgba(255,255,255,.05);text-align:right;"><span style="font-size:13px;font-weight:600;color:#F5ECD7;">${staff.email}</span></td>
                </tr>
                <tr>
                  <td style="padding:8px 0;"><span style="font-size:12px;color:#6B6054;">Temporary Password</span></td>
                  <td style="padding:8px 0;text-align:right;"><span style="font-size:15px;font-weight:800;color:#C9A84C;letter-spacing:0.15em;font-family:monospace;">${tempPassword}</span></td>
                </tr>
              </table>
            </div>
            <div style="background:rgba(255,255,255,.02);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:20px 24px;margin-bottom:28px;">
              ...
              ${[["Joining Date: ", joiningDate],["Shift: ", staff.shift],["Phone: ", staff.phoneno || "—"]].map(([l,v]) => `
            ...
            <div style="background:rgba(224,168,82,.08);border:1px solid rgba(224,168,82,.25);border-radius:10px;padding:14px 18px;margin-bottom:28px;">
              <p style="font-size:12px;color:#E0A852;margin:0;">⚠️ <strong>Important:</strong> Please change your password after your first login for security.</p>
            </div>
            <div style="text-align:center;margin-bottom:8px;">
              <a href="${loginUrl}" style="display:inline-block;padding:13px 36px;background:linear-gradient(135deg,#C9A84C,#E0C06A);color:#0E0C09;font-size:14px;font-weight:800;text-decoration:none;border-radius:10px;letter-spacing:0.05em;">Login to Staff Portal →</a>
            </div>
          </td>
        </tr>
        <tr>
          <td style="padding:20px 40px;border-top:1px solid rgba(255,255,255,.06);text-align:center;">
            <p style="font-size:11px;color:#4A4035;margin:0;">Royal Palace Resort · Staff Portal · ${new Date().getFullYear()}</p>
          </td>
        </tr>
      </table>
    </td></tr>
