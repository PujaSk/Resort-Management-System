...
const sendCheckInEmail = async ({
  ...
  isHallBk = false, collectedNow = false, amountCollected = 0,
  ...
  try {
    ...
    ` : amountDeferredToCheckout > 0 ? `
      <div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:14px 18px;border-radius:0 8px 8px 0;margin-bottom:24px;">
        ...
        <p style="margin:0;color:#666;font-size:13px;line-height:1.6;"><strong style="color:#d97706;">₹${fmt(amountDeferredToCheckout)}</strong> is due at checkout. Please have your preferred payment method ready at the front desk before departure.</p>
      </div>
    ` : `
          ...
          <table width="620" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="background:linear-gradient(135deg,#1a1208 0%,#2d2010 50%,#1a1208 100%);padding:40px 40px 30px;text-align:center;">
                ...
                <h1 style="margin:0;font-size:28px;color:#f5edd8;font-weight:700;letter-spacing:1px;">${isHallBk ? "Venue Access Confirmed" : "Welcome — You're Checked In!"}</h1>
            ...
            <tr>
              <td style="background:#C9A84C;padding:12px 40px;text-align:center;">
                <p style="margin:0;font-size:12px;color:#1a1208;font-weight:700;letter-spacing:2px;text-transform:uppercase;">Booking Reference: ${refId}</p>
              </td>
            </tr>
            <tr>
              <td style="padding:35px 40px;">
                <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 25px;">
                  ...
                  ${isHallBk ? `Your venue check-in is confirmed for today. We trust everything is in order for your event.` : `You have successfully checked in at <strong>Royal Palace Resort</strong>. We hope you have a wonderful and memorable stay.`}
                </p>
