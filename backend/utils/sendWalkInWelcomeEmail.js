          ...
          <table width="620" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="background:#C9A84C;padding:12px 40px;text-align:center;">
                <p style="margin:0;font-size:12px;color:#1a1208;font-weight:700;letter-spacing:2px;text-transform:uppercase;">Account Activated — Action Required</p>
              </td>
            </tr>
            <tr>
              <td style="padding:35px 40px;">
                <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 20px;">
                  ...
                  Welcome to <strong>Royal Palace Resort</strong>. Our team has registered your account so you can manage your bookings, view your stay history, and share your feedback — all from our website.
                </p>
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #e8e0d0;">
                  ...
                  <td style="padding:12px 16px;"><span style="font-family:monospace;font-size:18px;font-weight:800;color:#1a1208;background:#f5edd8;padding:6px 14px;border-radius:6px;border:1.5px solid #C9A84C;letter-spacing:0.15em;">${tempPassword}</span></td></tr>
                </table>
                <div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px 20px;border-radius:0 8px 8px 0;margin-bottom:25px;">
                  ...
                  <p style="margin:0;color:#666;font-size:13px;line-height:1.7;">This is a <strong>temporary password</strong> generated for you by our team. For your security, please log in and change it immediately. Go to <strong>My Profile → Change Password</strong> after logging in.</p>
                </div>
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:25px;border-radius:8px;overflow:hidden;border:1px solid #e8e0d0;">
                  <tr><td colspan="2" style="background:#f9f5ee;padding:12px 16px;font-size:12px;letter-spacing:2px;color:#8B6914;font-weight:700;text-transform:uppercase;border-bottom:1px solid #e8e0d0;">🌟 What You Can Do On Our Website</td></tr>
                  ${[
                ...
                <div style="text-align:center;margin-bottom:28px;">
                  <a href="${loginUrl}" target="_blank"
                    style="display:inline-block;background:linear-gradient(135deg,#C9A84C,#ddb94e);color:#1a1208;font-weight:800;font-size:14px;padding:14px 38px;border-radius:8px;text-decoration:none;letter-spacing:0.5px;">
                ...
                <p style="color:#333;font-size:14px;line-height:1.7;margin:0 0 25px;">
                  If you did not visit our resort or did not authorize this account creation, please contact us immediately at
